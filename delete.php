		...
		<div class="modal-content">
			...
			<div class=" justify-content-center">
			   <form action="" method="post"> 
				...
				<button type="submit" name="silmek" class="btn btn-danger">Delete</button>
              </form>
			</div>
			<?php
include("ayar.php");
...
{
 $sonuc=mysql_query("delete from users where sno=".$silinecekID);

	if($sonuc>0)
	{
		echo "<b>Başarıyla silindi , 2sn. sonra yönlendirileceksiniz.</b>";
	    header("refresh:2;url=index.php");
	}
	else{
		echo "Silinemedi ,2 sn. sonra yönlendirileceksiniz.";
		header("refresh:2;url=index.php");
	}
}
?>
